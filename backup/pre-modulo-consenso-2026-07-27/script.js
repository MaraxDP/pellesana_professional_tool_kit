/* =========================================================================
   ...
   7. HOME CARE (lista + modal) + ROUTINE BUILDER
...
const formazioneItems = [
    ...
    { id: "form-08", area: "marketing", tipo: "documento", titolo: "[Materiale da inserire] — Script per la consulenza", durata: "", formato: "PDF", descrizione: "Traccia di conversazione per la consulenza in cabina.", url: "assets/docs/materiali/script-consulenza.pdf", downloadUrl: "assets/docs/materiali/script-consulenza.pdf" },
    ...
    { id: "form-11", area: "anamnesi", tipo: "documento", titolo: "[Contenuto da inserire] — Modulo di consenso immagini", durata: "", formato: "PDF", descrizione: "Consenso per l'utilizzo delle immagini prima/dopo.", url: "assets/docs/materiali/consenso-immagini.pdf", downloadUrl: "assets/docs/materiali/consenso-immagini.pdf" },
    { id: "form-12", area: "anamnesi", tipo: "documento", titolo: "[Contenuto da inserire] — Checklist valutazione iniziale", durata: "", formato: "PDF", descrizione: "Checklist preliminare per l'analisi della pelle.", url: "assets/docs/materiali/checklist-valutazione.pdf", downloadUrl: "assets/docs/materiali/checklist-valutazione.pdf" }
];
...
const videoTrainingItems = [
    {
        ...
        description: "Panoramica sugli acidi cosmetici utilizzati nel protocollo: caratteristiche, indicazioni e modalità di impiego in cabina.",
        category: "Video Training",
        youtubeUrl: "https://www.youtube.com/embed/Xh40rTGyPzY",
        downloadUrl: "",
    ...
    },
    {
        ...
        title: "Exohair Plus",
        description: "Utilizzo di Exohair Plus nel trattamento professionale del cuoio capelluto e dei capelli indeboliti.",
        category: "Video Training",
        youtubeUrl: "https://www.youtube.com/embed/3j80eLjnhbk",
        downloadUrl: "",
    ...
    },
    {
        ...
        title: "Lip Volume & Eye Care",
        description: "Tecniche e prodotti dedicati al trattamento delle labbra e del contorno occhi.",
        category: "Video Training",
        youtubeUrl: "https://www.youtube.com/embed/AOJMq2ZyAuY",
        downloadUrl: "",
    ...
    },
    {
        ...
        title: "Micro & Nano",
        description: "Tecnologie di micro e nano veicolazione degli attivi nel percorso del Protocollo Pelle Sana.",
        category: "Video Training",
        youtubeUrl: "https://www.youtube.com/embed/Ena4k2tbX4w",
        downloadUrl: "",
    ...
    },
    {
        ...
        title: "Trattamento Biorivitalizzante con Esosomi",
        description: "Sequenza operativa del trattamento biorivitalizzante a base di esosomi.",
        category: "Video Training",
        youtubeUrl: "https://www.youtube.com/embed/mAasWGwxlh4",
        downloadUrl: "",
...
const resources = [
    ...
    { id: "doc-03", titolo: "[Documento da inserire] — Modulo di consenso trattamento", categoria: "moduli", descrizione: "Modulo stampabile per il consenso informato della cliente.", formato: "PDF", dataAggiornamento: "2026-07-23", apriUrl: "assets/docs/materiali/modulo-consenso.pdf", scaricaUrl: "assets/docs/materiali/modulo-consenso.pdf" },
    { id: "doc-04", titolo: "[Documento da inserire] — Scheda di anamnesi cliente", categoria: "schede-anamnesi", descrizione: "Scheda per la raccolta dati e la valutazione iniziale della cliente.", formato: "PDF", dataAggiornamento: "2026-07-23", apriUrl: "assets/docs/materiali/scheda-anamnesi.pdf", scaricaUrl: "assets/docs/materiali/scheda-anamnesi.pdf" },
...
function renderTreatmentPlans(filter) {
    ...
    if (!list) return;
    const items = (!filter || filter === "tutti") ? treatmentPlans : treatmentPlans.filter(p => p.problematica === filter);
