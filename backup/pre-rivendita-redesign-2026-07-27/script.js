...
// -------------------------------------------------------------------------
// FORMAZIONE E RISORSE — le 4 aree richieste (video introduttivi, video
// training, materiali marketing, anamnesi). PLACEHOLDER in attesa dei
// contenuti e link definitivi.
// -------------------------------------------------------------------------
const formazioneItems = [
    ...
    // B. Video training
    { id: "form-04", area: "training", tipo: "video", titolo: "[Titolo da inserire] — Sequenza di trattamento in cabina", durata: "--:--", formato: "", descrizione: "Modalità operative e sequenze di trattamento.", url: "" },
    { id: "form-05", area: "training", tipo: "video", titolo: "[Titolo da inserire] — Utilizzo degli attivi InLab", durata: "--:--", formato: "", descrizione: "Come utilizzare correttamente gli attivi professionali.", url: "" },
    { id: "form-06", area: "training", tipo: "video", titolo: "[Titolo da inserire] — Indicazioni della Master Trainer Annarita", durata: "--:--", formato: "", descrizione: "Consigli operativi diretti dalla Master Trainer.", url: "" },

    // C. Materiali marketing
